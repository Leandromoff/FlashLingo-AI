...
async function run() {
  ...
  console.log("Starting sequential generation of 8 decks with rate limit safety delay...");
  for (let i = 0; i < entries.length; i++) {
    ...
    // Rate limit space delay between separate decks
  ...
  fs.writeFileSync("generatedDecks.json", JSON.stringify(result, null, 2));
  console.log("Successfully wrote all decks to generatedDecks.json");
}
