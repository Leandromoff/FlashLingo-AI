...
export const LECCION_41_W2_S_DECK: FlashcardData[] = [
  ...
  },
  {
    ...
    portuguesePhonetic: "ca-mi-sé-ta",
  ...
  },
  {
    ...
    portuguesePhonetic: "ba-quê-ros / djins",
  ...
  },
  {
    ...
    portuguesePhonetic: "tcha-quê-ta",
  ...
  },
  {
    ...
    portuguesePhonetic: "pan-ta-ló-nes cór-tos",
    syllables: ["pan", "ta", "lo", "nes", " cor", "tos"],
    exampleSentence: "pantalones cortos",
  ...
  },
  {
    ...
    portuguesePhonetic: "gá-fas",
    syllables: ["ga", "fas"],
    exampleSentence: "gafas",
  ...
  },
  {
    ...
    pronunciation: "/a-ˈtwen-do/",
    portuguesePhonetic: "a-tuên-do",
    syllables: ["a", "tuen", "do"],
    exampleSentence: "atuendo",
  ...
  },
  {
    ...
    portuguesePhonetic: "quiê-ro com-prár un par de tha-pá-tos",
  ...
  },
  {
    ...
    portuguesePhonetic: "quiê-ro pro-bár-me ês-se bes-tí-do",
  ...
  },
  {
    ...
    pronunciation: "/ke ˈta-ʝa ˈe-ɾes/",
    portuguesePhonetic: "¿quê tá-lia é-res?",
    syllables: ["¿Qué", " ta", "lla", " e", "res?"],
  ...
  {
    id: 'leccion_41_23',
    word: "Estás usando un abrigo hermoso.",
    translation: "Você está usando um casaco bonito.",
    pronunciation: "/es-ˈtas u-ˈsan-do un a-ˈβɾi-ɣo eɾ-ˈmo-so/",
    portuguesePhonetic: "es-tás u-sán-do un a-brí-go er-mó-so",
    syllables: ["Es", "tás", " u", "san", "do", " un", " a", "bri", "go", " her", "mo", "so."],
    exampleSentence: "Estás usando un abrigo hermoso.",
  ...
  },
  {
    ...
    pronunciation: "/ˈe-ʝa se es-ˈta kam-ˈbja-ðo ðe ˈɾo-pa/",
    portuguesePhonetic: "ê-lia se es-tá cam-bián-do de rô-pa",
    syllables: ["E", "lla", " se", " es", "tá", " cam", "bian", "do", " de", " ro", "pa."],
  ...
  },
  {
    ...
    pronunciation: "/el es-ˈta a-ˈθjen-do un pas-ˈtel ðe-li-ˈθjo-so/",
    portuguesePhonetic: "él es-tá a-thiên-do un pas-tél de-li-thió-so",
    syllables: ["Él", " es", "tá", " ha", "cien", "do", " un", " pas", "tel", " de", "li", "cio", "so."],
    exampleSentence: "Él está haciendo un pastel delicioso.",
    exampleTranslation: "Ele está fazendo um bolo delicioso."
  },
  {
    id: 'leccion_41_26',
    word: "La clase está empezando ahora.",
    translation: "A aula está começando agora.",
    pronunciation: "/la ˈkla-se es-ˈta em-pe-ˈθan-ðo a-ˈo-ɾa/",
    portuguesePhonetic: "la clá-se es-tá em-pe-thán-do a-óra",
    syllables: ["La", " cla", "se", " es", "tá", " em", "pe", "zan", "do", " a", "ho", "ra."],
    exampleSentence: "La clase está empezando ahora.",
  ...
  },
  {
    ...
    pronunciation: "/ˈe-ʝos es-ˈtan ˈβjen-do ˈu-na pe-ˈli-ku-la a-ˈo-ɾa/",
    portuguesePhonetic: "ê-lios es-tán biên-do ú-na pe-lí-cu-la a-óra",
    syllables: ["E", "llos", " es", "tán", " vien", "do", " u", "na", " pe", "lí", "cu", "la", " a", "ho", "ra."],
    exampleSentence: "Ellos están viendo una película ahora.",
    exampleTranslation: "Eles estão assistindo um filme agora."
  },
  {
    id: 'leccion_41_28',
    word: "Nosotros estamos leyendo una historia divertida.",
    translation: "Nós estamos lendo uma história engraçada.",
    pronunciation: "/no-ˈso-tɾos es-ˈta-mos le-ˈʝen-do ˈu-na is-ˈto-ɾja ði-βeɾ-ˈti-ða/",
    portuguesePhonetic: "no-só-tros es-tá-mos le-iên-do ú-na is-tó-ria di-ber-tí-da",
    syllables: ["No", "so", "tros", " es", "ta", "mos", " le", "yen", "do", " u", "na", " his", "to", "ria", " di", "ver", "ti", "da."],
    exampleSentence: "Nosotros estamos leyendo una historia divertida.",
  ...
  },
  {
    ...
    pronunciation: "/los ˈni-ɲos es-ˈtan es-tu-ˈðjan-do en la ˈsa-la/",
    portuguesePhonetic: "los ní-nhios es-tán es-tu-dián-do en la sá-la",
    syllables: ["Los", " ni", "ños", " es", "tán", " es", "tu", "dian", "do", " en", " la", " sa", "la."],
  ...
  {
    id: 'leccion_41_31',
    word: "¡Estás usando calcetines graciosos!",
    translation: "Você está usando meias engraçadas!",
    pronunciation: "/es-ˈtas u-ˈsan-do kal-θe-ˈti-nes ɡɾa-ˈθjo-sos/",
    portuguesePhonetic: "es-tás u-sán-do cal-the-tí-nes gra-thió-sos",
    syllables: ["¡Es", "tás", " u", "san", "do", " cal", "ce", "ti", "nes", " gra", "cio", "sos!"],
    exampleSentence: "¡Estás usando calcetines graciosos!",
  ...
  },
  {
    ...
    portuguesePhonetic: "ne-the-sí-to cam-biár-me de rô-pa án-tes de ír-nos",
  ...
  },
  {
    ...
    portuguesePhonetic: "pre-fiê-ro u-sár rô-pa có-mo-da pá-ra tra-ba-rhár",
  ...
  {
    id: 'leccion_41_35',
    word: "Él siempre lleva gafas de sol.",
    translation: "Ele está sempre usando óculos de sol.",
    pronunciation: "/el ˈsjem-pɾe ˈʝe-βa ˈɣa-fas ðe sol/",
    portuguesePhonetic: "él siêm-pre lié-ba gá-fas de sol",
    syllables: ["Él", " siem", "pre", " lle", "va", " ga", "fas", " de", " sol."],
    exampleSentence: "Él siempre lleva gafas de sol.",
  ...
  },
  {
    ...
    portuguesePhonetic: "ê-lia es-tá a-blán-do con la ben-de-dó-ra a-óra",
    syllables: ["E", "lla", " es", "tá", " ha", "blan", "do", " con", " la", " ven", "de", "do", "ra", " a", "ho", "ra."],
    exampleSentence: "Ella está hablando con la vendedora ahora.",
    exampleTranslation: "Ela está falando com a vendedora agora."
  },
  {
    id: 'leccion_41_38',
    word: "Estamos cambiándonos de ropa para ir al bar.",
    translation: "Nós estamos mudando nossa roupa para ir ao bar.",
    pronunciation: "/es-ˈta-mos kam-ˈbjan-ðo-nos ðe ˈɾo-pa ˈpa-ɾa iɾ al βaɾ/",
    portuguesePhonetic: "es-tá-mos cam-bián-do-nos de rô-pa pá-ra ir al bar",
    syllables: ["Es", "ta", "mos", " cam", "bian", "do", "nos", " de", " ro", "pa", " pa", "ra", " ir", " al", " bar."],
    exampleSentence: "Estamos cambiándonos de ropa para ir al bar.",
  ...
  },
  {
    ...
    syllables: ["E", "llos", " te", " es", "tán", " es", "pe", "ran", "do", " en", " el", " cen", "tro", " co", "mer", "cial."],
  ...
  {
    id: 'leccion_41_40',
    word: "Estoy comprando un par de pantalones nuevos para mi esposo.",
    translation: "Eu estou comprando um par de calças novo para meu marido.",
    pronunciation: "/es-ˈtoi kom-ˈpɾan-ðo un paɾ ðe pan-ta-ˈlo-nes ˈnwe-βos ˈpa-ɾa mi es-ˈpo-so/",
    portuguesePhonetic: "es-tói com-prán-do un par de pan-ta-ló-nes nuê-bos pá-ra mi es-pó-so",
    syllables: ["Es", "toy", " com", "pran", "do", " un", " par", " de", " pan", "ta", "lo", "nes", " nue", "vos", " pa", "ra", " mi", " es", "po", "so."],
    exampleSentence: "Estoy comprando un par de pantalones nuevos para mi esposo.",
    exampleTranslation: "Eu estou comprando um par de calças novo para meu marido."
  },
  {
    id: 'leccion_41_41',
    word: "pequeño / talla chica",
    translation: "pequeno / P",
    pronunciation: "/pe-ˈke-ɲo o ˈta-ʝa ˈtʃi-ka/",
    portuguesePhonetic: "pe-quê-nho / tá-lia tchí-ca",
    syllables: ["pe", "que", "ño", " /", " ta", "lla", " chi", "ka"],
    exampleSentence: "pequeño / talla chica",
    exampleTranslation: "pequeno / P"
  },
  {
    id: 'leccion_41_42',
    word: "mediano / talla mediana",
    translation: "médio / M",
    pronunciation: "/me-ˈðja-no o ˈta-ʝa me-ˈðja-na/",
    portuguesePhonetic: "me-diá-no / tá-lia me-diá-na",
    syllables: ["me", "dia", "no", " /", " ta", "lla", " me", "dia", "na"],
    exampleSentence: "mediano / talla mediana",
    exampleTranslation: "médio / M"
  },
  {
    id: 'leccion_41_43',
    word: "grande / talla grande",
    translation: "grande / G",
    pronunciation: "/ˈɡɾan-de o ˈta-ʝa ˈɡɾan-de/",
    portuguesePhonetic: "grán-de / tá-lia grán-de",
    syllables: ["gran", "de", " /", " ta", "lla", " gran", "de"],
    exampleSentence: "grande / talla grande",
  ...
  },
  {
    ...
    portuguesePhonetic: "un par de tha-pá-tos",
  ...
  },
  {
    ...
    pronunciation: "/un paɾ ðe θa-pa-ˈti-ʝas o ˈte-nis/",
    portuguesePhonetic: "un par de tha-pa-tí-lias / tê-nis",
    syllables: ["un", " par", " de", " za", "pa", "ti", "llas", " /", " te", "nis"],
    exampleSentence: "un par de zapatillas / tenis",
    exampleTranslation: "um par de tênis"
  },
  {
    id: 'leccion_41_46',
    word: "un par de pantalones",
    translation: "um (par de) calça",
    pronunciation: "/un paɾ ðe pan-ta-ˈlo-nes/",
    portuguesePhonetic: "un par de pan-ta-ló-nes",
    syllables: ["un", " par", " de", " pan", "ta", "lo", "nes"],
    exampleSentence: "un par de pantalones",
    exampleTranslation: "um (par de) calça"
  },
  {
    id: 'leccion_41_47',
    word: "un par de pantalones cortos",
    translation: "um (par de) bermuda",
    pronunciation: "/un paɾ ðe pan-ta-ˈlo-nes ˈkoɾ-tos/",
    portuguesePhonetic: "un par de pan-ta-ló-nes cór-tos",
    syllables: ["un", " par", " de", " pan", "ta", "lo", "nes", " cor", "tos"],
    exampleSentence: "un par de pantalones cortos",
    exampleTranslation: "um (par de) bermuda"
  },
  {
    id: 'leccion_41_48',
    word: "un par de vaqueros",
    translation: "um (par de) calça jeans",
    pronunciation: "/un paɾ ðe βa-ˈke-ɾos/",
    portuguesePhonetic: "un par de ba-quê-ros",
    syllables: ["un", " par", " de", " va", "que", "ros"],
    exampleSentence: "un par de vaqueros",
  ...
  },
  {
    ...
    word: "negro / negra",
    translation: "preto",
    pronunciation: "/ˈne-ɣɾo o ˈne-ɣɾa/",
    portuguesePhonetic: "nê-gro / nê-gra",
    syllables: ["ne", "gro", " /", " ne", "gra"],
    exampleSentence: "negro / negra",
  ...
  },
  {
    ...
    word: "rosa",
    translation: "rosa",
    pronunciation: "/ˈɾo-sa/",
    portuguesePhonetic: "rô-sa",
    syllables: ["ro", "sa"],
    exampleSentence: "rosa",
  ...
  },
  {
    ...
    word: "morado / morada",
    translation: "roxo",
    pronunciation: "/mo-ˈɾa-ðo o mo-ˈɾa-ða/",
    portuguesePhonetic: "mo-rá-do / mo-rá-da",
    syllables: ["mo", "ra", "do", " /", " mo", "ra", "da"],
    exampleSentence: "morado / morada",
  ...
  },
  {
    ...
    pronunciation: "/ˈɾo-xo o ˈɾo-xa/",
    portuguesePhonetic: "rô-rho / rô-rha",
    syllables: ["ro", "jo", " /", " ro", "ja"],
    exampleSentence: "rojo / roja",
  ...
  },
  {
    ...
    portuguesePhonetic: "ma-rón",
    syllables: ["ma", "rrón"],
    exampleSentence: "marrón",
  ...
  },
  {
    ...
    translation: "amarelo",
    pronunciation: "/a-ma-ˈɾi-ʝo o a-ma-ˈɾi-ʝa/",
    portuguesePhonetic: "a-ma-rí-lio / a-ma-rí-lia",
    syllables: ["a", "ma", "ri", "llo", " /", " a", "ma", "ri", "lla"],
    exampleSentence: "amarillo / amarilla",
  ...
  {
    id: 'leccion_41_62',
    word: "Cuestan 100 dólares.",
    translation: "Custam 100 dólares.",
    pronunciation: "/ˈkwes-tan θjen ˈðo-la-ɾes/",
    portuguesePhonetic: "cuês-tan thiên dó-la-res",
    syllables: ["Cues", "tan", " 100", " dó", "la", "res."],
    exampleSentence: "Cuestan 100 dólares.",
    exampleTranslation: "Custam 100 dólares."
  },
  {
    id: 'leccion_41_63',
    word: "Soy de talla mediana.",
    translation: "Eu sou (tamanho) médio.",
    pronunciation: "/soi ðe ˈta-ʝa me-ˈðja-na/",
    portuguesePhonetic: "sói de tá-lia me-diá-na",
    syllables: ["Soy", " de", " ta", "lla", " me", "dia", "na."],
    exampleSentence: "Soy de talla mediana.",
