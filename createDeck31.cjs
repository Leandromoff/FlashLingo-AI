...
const rawDeck = [
  ...
  {w: "They don't need to study business in college.", t: "Eles não precisam estudar negócios na faculdade.", p: "/ðeɪ doʊnt nid tə ˈstʌdi ˈbɪznɪs ɪn ˈkɑlɪdʒ/", pp: "dêi dôunt nid tchu stâ-di bíz-nes in có-ledj", s: ["They", " don't", " need", " to", " stu", "dy", " bu", "si", "ness", " in", " col", "lege."]},
  {w: "I don't want to start this task now.", t: "Eu não quero começar esta tarefa agora.", p: "/aɪ doʊnt wɑnt tə stɑrt ðɪs tæsk naʊ/", pp: "ai dôunt uánt tchu start díz tésk náu", s: ["I", " don't", " want", " to", " start", " this", " task", " now."]},
