...
const updatedContent = content.replace("export const STATIC_DECKS: Record<string, Record<string, FlashcardData[]>> = {", newDeck);

const finalContent = updatedContent.replace("  lucky_man: {\n    en: LUCKY_MAN_DECK\n  }", "  lucky_man: {\n    en: LUCKY_MAN_DECK\n  },\n  listen_watch: {\n    en: LISTEN_WATCH_DECK\n  }");

fs.writeFileSync('data/staticDecks.ts', finalContent);
console.log("Deck appended");
