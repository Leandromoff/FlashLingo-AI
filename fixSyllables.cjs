...
const content = fs.readFileSync('data/staticDecks.ts', 'utf8');

const oldDeck = `export const LISTEN_WATCH_DECK: FlashcardData[] = [
  {
    id: 'listen_watch_1',
    word: 'listen',
    translation: 'ouvir',
  ...
  },
  {
    ...
    exampleTranslation: 'Eles não estavam se divertindo com aquela peça teatral.'
  },
  {
    id: 'listen_watch_12',
    word: 'podcast',
...
const newDeck = `export const LISTEN_WATCH_DECK: FlashcardData[] = [
  {
    id: 'listen_watch_1',
    word: 'listen',
    translation: 'ouvir',
...
fs.writeFileSync('data/staticDecks.ts', content.replace(oldDeck, newDeck));
console.log("Fixed syllables.");
