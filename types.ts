...
export const PREDEFINED_TOPICS = [
  ...
  { id: 'leccion_1_vocabulario_a1_s', label: 'Lección 1', isStatic: true, group: 'Vocabulario A1-S' },
  { id: 'leccion_2_vocabulario_a1_s', label: 'Lección 2', isStatic: true, group: 'Vocabulario A1-S' },
  { id: 'leccion_3_vocabulario_a1_s', label: 'Lección 3', isStatic: true, group: 'Vocabulario A1-S' },
  { id: 'leccion_4_vocabulario_a1_s', label: 'Lección 4', isStatic: true, group: 'Vocabulario A1-S' },
  { id: 'leccion_5_vocabulario_a1_s', label: 'Lección 5', isStatic: true, group: 'Vocabulario A1-S' },
  { id: 'leccion_6_vocabulario_a1_s', label: 'Lección 6', isStatic: true, group: 'Vocabulario A1-S' }
];